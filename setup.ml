...
(* OASIS_START *)
(* DO NOT EDIT (digest: d135cfe947dac335db7998839dfdf661) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "$u\228\199{\129\228w\004?@\165\1288\227_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
