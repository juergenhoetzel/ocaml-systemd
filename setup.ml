...
(* OASIS_START *)
(* DO NOT EDIT (digest: 80ec6213974d71b01a18ab3b2566f848) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["J\195\188rgen H\195\182tzel"];
          homepage = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["journald_stubs.c"; "daemon_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lsystemd"])];
                   ...
                   {
                      lib_modules = ["Journald"; "Daemon"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "systemd";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for systemd";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\171\140.6(\252\203,\219QH\175\253\170\194\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
